...
>`python3 -m http.server 3000 -d src/system_design/messaging/push/websockets/connect_4/frontend/`

Then in another terminal run the websocket server:

>`python3 src/system_design/messaging/push/connect_4/websocket_client_server/main.py`