...
@pytest.fixture
def valid_user_id():
    return "091c7c77-6ad0-11ef-b000-0242ac130002"


@pytest.fixture
def valid_blog_post_id():
    return "091c7c77-6ad0-11ef-b000-0242ac130001"


@pytest.fixture
def setup_test_database(flask_sql_alchemy_app, valid_user_id, valid_blog_post_id):
    with flask_sql_alchemy_app.app_context():
        _db.create_all()

        user_uuid1 = valid_user_id
        ...
        _db.session.add_all([
            Review(review_id=str(uuid.uuid4()), rating=4.0, blog_post_id=blog_post_uuid1, user_id=user_uuid2),
            Review(review_id=str(uuid.uuid4()), rating=3.5, blog_post_id=blog_post_uuid1, user_id=user_uuid3)
        ])
